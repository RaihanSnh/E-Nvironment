      ...
      <Container className="relative z-10">
        <div className="max-w-3xl">
          <h1 className="medieval-heading mb-6">
            <span className="text-primary">Intelligent</span> IoT Technology for a{" "}
            <span className="text-secondary">Sustainable</span> Future
          </h1>
          <p className="text-lg md:text-xl mb-8 text-muted-foreground">
            Discover our collection of smart devices designed to help you monitor, conserve, and protect our environment while enhancing your modern lifestyle.
          </p>
